...
<div id="invoice-template" class="card-body">
            ...
            <div id="invoice-customer-details" class="row pt-2">
              ...
              <div class="col-md-6 col-sm-12  text-right">
                {{-- <p> --}}
                  <span class="text-muted m-r-10">Receipt Date: </span> {{ nice_date($cash_entry->ValueDate) }} <br>
                {{-- </p> --}}
                  <span class="text-muted m-r-10">Account Manager: </span> <b>{{ $client_details->account_manager->AccountManager ?? 'Somebody Here' }}</b> <br>
                {{-- </p> --}}
                {{-- <p> --}}
                  <span class="text-muted m-r-10">Contact Number: </span>{{ $client_details->account_manager->MobileNumber ?? '-' }}
                {{-- </p> --}}
              </div>
            </div> <hr>
            <!--/ Invoice Customer Details -->
