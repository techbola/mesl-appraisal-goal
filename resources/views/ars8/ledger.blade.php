...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank8" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger8" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon8')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger8', data, function(data, textStatus, xhr) {
        ...
        // load item
        $.get('/load/ledger8', function(data) {
            // console.log(data);
