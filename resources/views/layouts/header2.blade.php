    ...
    <div class="page-container ">
          ...
          <div class="visible-lg visible-md m-t-10">
            ...
            <div class="dropdown pull-right">
              <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span style="display: inline-block;" class="abbr-avatar">{{ Auth::user()->abbreviation(Auth::user()->name) }}</span>
            </span>
              </button>
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">{{ Route::currentRouteName() }}</a></li>
                </ul>
                <span  class="pull-right" style="margin-top : -45px">
                </style><button onclick="goBack()" class="btn btn-sm btn-rounded btn-primary">Back</button></span><div class="clearfix"></div>
                <!-- END BREADCRUMB -->
              </div>
            </div>
          </div>
          ...
          <div class="jumbotron" data-pages="parallax" style="top: -25px">
        ...
        <div class="container-fluid container-fixed-lg footer">
          <div class="copyright sm-text-center">
            <p class="small no-margin pull-left sm-pull-reset">
              ...
              <span class="font-montserrat">TIMS</span>.
