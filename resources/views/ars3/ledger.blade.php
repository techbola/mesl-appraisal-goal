...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank3" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger3" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon3')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
                    ...
                    <table data-vertable="ver1" class="table">
                        <thead>
                            <tr class="row100 head">
                                ...
                                <th class="column100 column3" data-column="column3">LEDGER</th>
                        ...
                        <tbody class="load-ledger-item">
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" onclick="addLedgerItem()" class="om-link">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger3', data, function(data, textStatus, xhr) {
        ...
        // load item
        $.get('/load/ledger3', function(data) {
            // console.log(data);
