...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function checkMatch(id, type, amount) {
            ...
            if(type == 'ledger'){
                ...
                if(ledgerCheck.is(':checked')){
                    ...
                    $.post('/flag/ledger/checked3', data, function(data, textStatus, xhr) {
                    ...
                    $.post('/flag/ledger/unchecked3', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
            ...
            if(type == 'bank'){
                if(bankCheck.is(':checked')){
                    ...
                    // update ledger has been checked
                    $.post('/flag/bank/checked3', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
                    ...
                    // console.log(id+' bank item has been uncheck');
                     $.post('/flag/bank/unchecked3', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
        ...
        function matchData() {
            ...
            $.get('/load/recon/total3', function(data) {
                // console.log(data);
                // $(".match-results").html("");
                // iterate
