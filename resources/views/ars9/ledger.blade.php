...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank9" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger9" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon9')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger9', data, function(data, textStatus, xhr) {
        ...
        // load item
        $.get('/load/ledger9', function(data) {
            // console.log(data);
