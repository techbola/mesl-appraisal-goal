...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {{ Form::select('StateOfBirth', [ '' =>  'Select State'] + $states->pluck('State', 'StateRef')->toArray(),null, ['class'=> "full-width",'data-placeholder' => "Choose your State", 'data-init-plugin' => "select2"]) }}
        </div>
    </div>
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {{ Form::select('CountryOfBirth', [ '' =>  'Select Country'] + $countries->pluck('Country', 'CountryRef')->toArray(),null, ['class'=> "full-width",'data-placeholder' => "Choose your Country", 'data-init-plugin' => "select2"]) }}
        </div>
    </div>
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {{ Form::text('CityOfOrigin', null,  ['class' => 'form-control required', 'placeholder' => 'Enter City of Birth', 'required']) }}
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-sm-3">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {{ Form::text('NationalityOfOrigin', null,  ['class' => 'form-control', 'placeholder' => 'Enter Mobile PhoneNumber']) }}
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="">
            {{ Form::label('MaritalStatusID','Marital Status', ['class' => 'form-label required']) }}
            {{ Form::select('MaritalStatusID', [ 0 =>  'Marital Status'] + $status->pluck('MaritalStatus', 'MaritalStatusRef')->toArray(),null, ['class'=> "full-width",'data-placeholder' => "Choose your Marital Status", 'data-init-plugin' => "select2", 'required']) }}
        </div>
    </div>
</div>
<div class="row">
