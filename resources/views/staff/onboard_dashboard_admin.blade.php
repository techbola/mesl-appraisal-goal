                    ...
                    <td>{{$staff_onboard->StaffName}}</td>
                      ...
                      <td>
                        @if(!empty($staff_onboard->OfficeSpace) && empty($staff_onboard->OfficeTable))
                          @php
                            $staff_onboard->OfficeSpace = $staff_onboard->OfficeSpace
                          @endphp
                        @elseif(!empty($staff_onboard->OfficeSpace))
                          @php
                            $staff_onboard->OfficeSpace = $staff_onboard->OfficeSpace.", "
                          @endphp
                        @endif
                        @if(!empty($staff_onboard->OfficeTable) && !empty($staff_onboard->BusinessCard))
                          @php
                            $staff_onboard->OfficeTable = $staff_onboard->OfficeTable.", "
                          @endphp
                        @endif
