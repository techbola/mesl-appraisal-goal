<div class="tab-pane padding-20 slide-left" id="tab4">
	<div class="row row-same-height">
		...
		<div class="col-md-12">
			<form action="{{ route('appraisal.bsc_internal.store') }}" method="post" enctype="multipart/form-data">
				@csrf
				{{-- Internal Process --}}
						...
						<table class="table">
							...
							<tr>
								...
								<th scope="col" class="text-center text-white bg-info">
									<a style="color: orange;font-size: 30px;" title="Add More Field" id="addInternalRow">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-hover" id="basicTable">
								...
								<tr>
									<th style="width:1%">
										<form action="{{ route('appraisal.deleteInternalAppraisals') }}" method="post">
											{{ csrf_field() }}
