...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger', data, function(data, textStatus, xhr) {
