...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function pullBankDataToArs(argument) {
            ...
            // post data 
            $.post('/save/data/recon/table', data, function(data, textStatus, xhr) {
                ...
                if(data.status == 'success'){
                    ...
                    `);
                    window.location.href = "/entry/ars";
                }
        ...
        $.get('/load/location/name', function(data) {
            /*optional stuff to do after success */
        ...
        $.get('/load/ledger/name', function(data) {
            /*optional stuff to do after success */
            $("#select_ledger").html("");
