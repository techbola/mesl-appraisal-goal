                   ...
                   <tr>
                     ...
                     <td class="actions" width="140">
                       @if(!$comp->sent())
                        ...
                        <a href="#" data-toggle="modal" data-target="#send_to" data-comp-id="{{ $comp->id }}" class="putter btn btn-sm btn-complete m-r-5" data-toggle="tooltip" title="">Send To <i style="margin-left: 7px" class="m-l-10 fa fa-chevron-right"></i></a>
            ...
            <table class="table tableWithSearch">
                ...
                <tbody>
                 ...
                 <tr>
                   ...
                   <td>{!! $comp->complaints !!}</td>
                   <td>
                     <a class="btn btn-info" href="{{ route('facility-management.view-comments', ['id' => $comp->id]) }}">
                        View Discussions
                     </a>
                   </td>
                 </tr>
