...
<div class="container-fluid container-fixed-lg bg-white">
    ...
    <div class="panel panel-transparent">
        ...
        {{ Form::open(['action' => 'CashEntryController@post_bill_vendor', 'autocomplete' => 'off', 'novalidate' => 'novalidate', 'role' => 'form']) }}
            <input type="submit" name="" class="btn btn-sm btn-primary btn-rounded" value="Post Invoice(s)">
