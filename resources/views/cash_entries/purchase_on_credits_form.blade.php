    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="controls">
                ...
                {{ Form::select('GLIDDebit', [ '' =>  'Select Customer Account'] + $debit_acct_details->pluck('CUST_ACCT', 'GLRef')->toArray(),null, ['class'=> "full-width", 'data-init-plugin' => "select2", 'class'=>"required", 'required']) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="controls">
                ...
                {{ Form::select('GLIDCredit', [ '' =>  'Select Customer Account'] + $credit_acct_details->pluck('CUST_ACCT', 'GLRef')->toArray(),null, ['class'=> "full-width", 'data-init-plugin' => "select2", 'class'=>"required", 'required' => 'required']) }}
            </div>
        </div>
    </div>
</div>
