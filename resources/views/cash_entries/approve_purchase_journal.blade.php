...
<div class="container-fluid container-fixed-lg">
	<!-- START PANEL -->
	<div class="card-box">
		<div class="card-title">Approve Purchase Journal Posting</div>
		...
		<div class="panel-body">
			<div class="notice text-center hide" id="approve_notification">
				<p>Purchase journal(s) Approved Successfully</p>
			</div><br>

			<div class="exp text-center hide" id="reject_notification">
				<p>Purchase journal(s) Rejected Successfully</p>
			</div><br>
			...
			<a href="#" id="submit_bill" class="btn btn-info btn-lg"  title="">Approve Purchase Journal Posting(s)</a>
			<button type="submit" id="reject_postings" class="btn btn-danger btn-lg">Reject Purchase Journal Posting(s)</button>
