    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="controls">
                ...
                {{-- {{ Form::select('GLIDDebit', [ '' =>  'Select Bank Account'] + $customer_details->pluck('CUST_ACCT', 'GLRef'),null, ['class'=> "full-width", 'data-init-plugin' => "select2"]) }} --}}
...
{{ Form::hidden('PostingTypeID', 1, ['class' => 'form-control', 'placeholder' => 'Post Date']) }}
    {{ Form::hidden('GLIDCredit', 219, ['class' => 'form-control', 'placeholder' => 'Post Date']) }}
</div>

<div class="row">
    <div class="pull-right">
        {{ Form::hidden('CurrencyID',2) }}
