...
@section('title')
  Project Performance Gragh - Budget & Timeline Report
@endsection

@section('page-title')
  Project Performance Gragh - Budget & Timeline
@endsection

@section('content')

  @include('reports.md.project.nav')
  ...
  <div class="card-box" id="print-content">
      <h3 class="card-title">Project Performance Gragh - Budget & Timeline Report</h3>
