...
@section('title')
  Overall Project Summary - Completed &amp; Ongoing Report
@endsection

@section('page-title')
  Overall Project Summary - Completed &amp; Ongoing
@endsection
...
@section('content')
  ...
  <div class="card-box" id="print-content">
      <h3 class="card-title">Overall Project Summary - Completed &amp; Ongoing Report</h3>
