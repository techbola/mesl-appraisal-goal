...
@section('title')
  Leave Utilzation Graph per month Report
@endsection

@section('page-title')
  Leave Utilzation Graph per month
@endsection

@section('content')

  @include('reports.md.hr-summary.nav')
  ...
  <div class="card-box" id="print-content">
      <h3 class="card-title">Leave Utilzation Graph per month Report</h3>
