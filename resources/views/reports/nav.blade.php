			...
			<div class="panel panel-info">
				<a href="{{ route('trial_balance3') }}">
					<div class="panel-heading">
						<img src="{{ asset('assets/img/icons/report1.png') }}" alt="">
						<h6 class="bold theme-primary">Trial Balance</h6>
					</div>
				</a>
			</div>
		</div>
		...
		<div class="col-sm-4 text-center">
			<div class="panel panel-info">
					<a href="{{ route('profit_loss') }}">
						<div class="panel-heading">
						<img src="{{ asset('assets/img/icons/report2.png') }}" alt="">
						<h6 class="bold theme-primary">Profit & Loss</h6>
					</div>
				</a>
			</div>
		</div>
