...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank2" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger2" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon2')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger2', data, function(data, textStatus, xhr) {
        ...
        // load item
        $.get('/load/ledger2', function(data) {
            // console.log(data);
