...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank6" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger6" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon6')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger6', data, function(data, textStatus, xhr) {
        ...
        // load item
        $.get('/load/ledger6', function(data) {
            // console.log(data);
