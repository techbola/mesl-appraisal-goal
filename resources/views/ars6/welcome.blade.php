...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function checkMatch(id, type, amount) {
            ...
            if(type == 'ledger'){
                ...
                if(ledgerCheck.is(':checked')){
                    ...
                    $.post('/flag/ledger/checked6', data, function(data, textStatus, xhr) {
                    ...
                    $.post('/flag/ledger/unchecked6', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
            ...
            if(type == 'bank'){
                if(bankCheck.is(':checked')){
                    ...
                    // update ledger has been checked
                    $.post('/flag/bank/checked6', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
                    ...
                    // console.log(id+' bank item has been uncheck');
                     $.post('/flag/bank/unchecked6', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
        ...
        function matchData() {
            ...
            $.get('/load/recon/total6', function(data) {
                // console.log(data);
                // $(".match-results").html("");
                // iterate
                $.each(data, function(index, val) {
                    if(val.Total == 0){
                        // body...
                        <?php
                            DB::statement("exec procReconMatching6");
                        ?>
