...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function checkMatch(id, type, amount) {
            ...
            if(type == 'ledger'){
                ...
                if(ledgerCheck.is(':checked')){
                    ...
                    $.post('/flag/ledger/checked7', data, function(data, textStatus, xhr) {
                    ...
                    $.post('/flag/ledger/unchecked7', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
            ...
            if(type == 'bank'){
                if(bankCheck.is(':checked')){
                    ...
                    // update ledger has been checked
                    $.post('/flag/bank/checked7', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
                    ...
                    // console.log(id+' bank item has been uncheck');
                     $.post('/flag/bank/unchecked7', data, function(data, textStatus, xhr) {
                        /*optional stuff to do after success */
                        refreshReconTotal();
                        console.log(data);
                    });
        ...
        function matchData() {
            ...
            $.get('/load/recon/total7', function(data) {
                // console.log(data);
                // $(".match-results").html("");
                // iterate
                $.each(data, function(index, val) {
                    if(val.Total == 0){
                        // body...
                        <?php
                            DB::statement("exec procReconMatching7");
                        ?>
