							...
							<tr>
								...
								<td class="v-align-middle">
									...
									@elseif($appraisal->sentFlag && $appraisal->status == 2)
										<a href="{{ route('appraisal.supervisor.view.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">View Goals</a>

									@elseif(!$appraisal->sentFlag && $appraisal->status == 3 || !$appraisal->sentFlag && $appraisal->status == 5)
										<a href="{{ route('appraisal.supervisor.submit.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">Submit Goals To Supervisor</a>
										|
										<a href="{{ route('appraisal.supervisor.delete.appraisal', ['id' => $appraisal->id]) }}" class="btn btn-danger btn-sm">Delete</a>

									@elseif($appraisal->sentFlag && $appraisal->status == 4)
										<a href="{{ route('appraisal.supervisor.view.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">View Goals</a>

									@elseif($appraisal->sentFlag && $appraisal->status == 6 && $appraisal->appraisalStatus == 1)
										<p><a href="{{ route('appraisal.supervisor.view.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm mb">View Goals</a></p>
										<p><a href="{{ route('appraisal.supervisor.view.appraisals', ['id' => $appraisal->id]) }}" class="btn btn-primary btn-sm">View Appraisal</a></p>

									@elseif($appraisal->sentFlag && $appraisal->status == 6 && $appraisal->appraisalStatus == 0 && $appraisal->startAppraisalFlag == 0)
										<p><a href="{{ route('appraisal.supervisor.view.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm mb">View Goals</a></p>
										<p><a href="{{ route('appraisal.supervisor.start.appraisal', ['id' => $appraisal->id]) }}" class="btn btn-primary btn-sm">Start Appraisal</a></p>
										<p><a href="{{ route('appraisal.supervisor.submit.appraisal.supervisor', ['id' => $appraisal->id]) }}" class="btn btn-success btn-sm">Submit Appraisal To Supervisor</a></p>

									@elseif($appraisal->sentFlag && $appraisal->status == 6 && $appraisal->appraisalStatus == 0 && $appraisal->startAppraisalFlag == 1)
										<p><a href="{{ route('appraisal.supervisor.view.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm mb">View Goals</a></p>
										<p><a href="{{ route('appraisal.supervisor.edit.appraisals', ['id' => $appraisal->id]) }}" class="btn btn-primary btn-sm">Edit Appraisal</a></p>
										<p><a href="{{ route('appraisal.supervisor.submit.appraisal.supervisor', ['id' => $appraisal->id]) }}" class="btn btn-success btn-sm">Submit Appraisal To Supervisor</a></p>
									...
									@else
										<p><a href="{{ route('appraisal.supervisor.submit.goals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">Submit Goals To Supervisor</a></p>
										<p><a href="{{ route('appraisal.supervisor.edit.goals', ['id' => $appraisal->id]) }}" class="btn btn-primary btn-sm">Edit Goals</a></p>
										<p><a href="{{ route('appraisal.supervisor.delete.appraisal', ['id' => $appraisal->id]) }}" class="btn btn-danger btn-sm">Delete</a></p>
									@endif
