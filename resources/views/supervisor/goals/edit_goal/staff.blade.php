...
@section('content')
	...
	@include('errors.list')
		...
		<div class="container-fluid container-fixed-lg">
			...
			<div id="rootwizard" class="m-t-50">
				<!-- Nav tabs -->
					@include('supervisor.goals.edit_goal.includes.appraisal_nav')
				<!-- Tab panes -->

				<div class="tab-content">

					@include('supervisor.goals.edit_goal.includes.bsc_financial')
					@include('supervisor.goals.edit_goal.includes.bsc_customer')
					@include('supervisor.goals.edit_goal.includes.bsc_internal')
					@include('supervisor.goals.edit_goal.includes.bsc_learning')
					@include('supervisor.goals.edit_goal.includes.staff_behavioural')
					@include('supervisor.goals.edit_goal.includes.others')
	...
	@include('supervisor.goals.edit_goal.includes.edit_appraisal_modals')
