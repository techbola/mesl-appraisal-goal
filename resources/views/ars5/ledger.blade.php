...
{{-- body section --}}
@section('content')
    <li class="nav-item"><a href="/bank5" class="btn btn-link">Add Bank Item</a></li>
    <li class="nav-item"><a href="/ledger5" class="btn btn-link">Add Ledger Item</a></li>
    <li class="nav-item"><a href="{{ route('ars_recon5')}}" class="btn btn-link">Reconciliation View</a></li>
    <div class="limiter">
...
@section('scripts')
    <script type="text/javascript">
        function addLedgerItem() {
            ...
            // post data
            $.post('/ledger5', data, function(data, textStatus, xhr) {
        ...
        // load item
        $.get('/load/ledger5', function(data) {
            // console.log(data);
