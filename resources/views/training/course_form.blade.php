                              <div class="col-sm-4">
                                   <div class="form-group">
                                       <div class="controls">
                                           {{ Form::label('Select Agency Name' ) }}
                                               {{ Form::select('AgencyRef', [ ' ' =>  'Select Agency'] + $training_agencies->pluck('Agency', 'AgencyRef')->toArray(),null, ['class'=> "full-width",'data-placeholder' => "Select Agency Name", 'data-init-plugin' => "select2", 'required']) }}
                                       </div>
                                  </div>
                              </div>
