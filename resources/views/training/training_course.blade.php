...
@section('content')
      ...
      <div style="padding: 30px">
         <ul class="nav nav-pills pull-right">
             <li role="presentation"><a href="#" style="color: #fff" class="btn btn-info btn-lg"  data-target="#modalFillIn2" data-toggle="modal" id="btnFillSizeToggler2">Create New Training Course</a></li>
         </ul>
      </div><div class="clearfix"></div>
  			<div class="card-title pull-left" style="font-size: 20px">List of Training Course(s)</div><div class="clearfix"></div>
           <div class="row"><hr>
