  ...
  <script>
    function get_balances() {
      if ($("#start_date").val() && $("#end_date").val() && $("#select_bank").val()) {
        ...
        $.post('/recon/get_bank_balances4', { start: $("#start_date").val(), end: $("#end_date").val(), bank: $("#select_bank").val() }, function(data, status){
    ...
    <script type="text/javascript">
        ...
        function pullBankDataToArs(argument) {
            ...
            // post data
            $.post('/save/data/recon/table4', data, function(data, textStatus, xhr) {
                ...
                if(data.status == 'success'){
                    ...
                    `);
                    window.location.href = "/entry/ars4";
                }
        ...
        // get bank name
        $.get('/load/bank/name4', function(data) {
            console.log(data);
            $("#select_bank").html("");
            $("#select_bank").append(`
        ...
        $.get('/load/location/name4', function(data) {
            /*optional stuff to do after success */
        ...
        $.get('/load/ledger/name4', function(data) {
            /*optional stuff to do after success */
            $("#select_ledger").html("");
