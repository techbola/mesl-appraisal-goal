    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ App\Helpers::get_option('Rate', $rating->Rate) }}%</td>
        </tr>
        <tr>
          <td style="font-weight:bold">BusinessLine</td>
          <td>{{ App\Helpers::get_option('BusinessLine', $rating->BusinessLine) }}</td>
        </tr>
        <tr>
          <td style="font-weight:bold">OfficeAddress</td>
          <td>{{ App\Helpers::get_option('OfficeAddress', $rating->OfficeAddress) }}</td>
        </tr>
        <tr>
          <td style="font-weight:bold">ResidentialAddress</td>
          <td>{{ App\Helpers::get_option('ResidentialAddress', $rating->ResidentialAddress) }}</td>
        </tr>
        <tr>
          <td style="font-weight:bold">Purpose</td>
          <td>{{ App\Helpers::get_option('Purpose', $rating->Purpose) }}</td>
        </tr>
        <tr>
          <td style="font-weight:bold">LoanType</td>
          <td>{{ App\Helpers::get_option('LoanType', $rating->LoanType) }}</td>
        </tr>
      </tbody>
    </table>
