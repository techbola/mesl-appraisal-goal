...
Route::middleware(['auth'])->group(function () {
    ...
    Route::name('appraisal.')->middleware(['auth'])->prefix('appraisal')->group(function () {
...
Route::get('setup/leave_days', 'SetupController@leave_days_setup')->name('setup_leave_setup');
