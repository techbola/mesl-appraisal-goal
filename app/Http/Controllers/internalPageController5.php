...
class internalPageController5 extends Controller
{
    ...
    public function recon_statement()
    {
      ...
      $rows = collect(\DB::select("exec procReconStatement5"));
      $details = \DB::table('tblReconSetup5')->first();
      ...
      // dd($rows);
      return view('ars5.recon_statement', compact('rows', 'from', 'to', 'details', 'open_bal'));
    }
