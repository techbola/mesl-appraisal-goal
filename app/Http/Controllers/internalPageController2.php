...
class internalPageController2 extends Controller
{
    ...
    public function recon_statement()
    {
      ...
      $rows = collect(\DB::select("exec procReconStatement2"));
      $details = \DB::table('tblReconSetup2')->first();
      ...
      // dd($rows);
      return view('ars2.recon_statement', compact('rows', 'from', 'to', 'details', 'open_bal'));
    }
