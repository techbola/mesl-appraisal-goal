...
class jsonResponseController2 extends Controller
{
    ...
    public function loadAllItems(Request $request)
    {
        ...
        $all_bank_items = DB::table('ars_banks2')->where('match_flag', 0)->orderBy('date', 'ASC')->get();
        ...
        $all_ledger_items = DB::table('ars_ledgers2')->where('match_flag', 0)->orderBy('date', 'ASC')->get();
