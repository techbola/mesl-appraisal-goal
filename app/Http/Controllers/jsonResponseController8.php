...
class jsonResponseController8 extends Controller
{
    ...
    public function loadAllItems(Request $request)
    {
        ...
        $all_bank_items = DB::table('ars_banks8')->where('match_flag', 0)->orderBy('date', 'ASC')->get();
        ...
        $all_ledger_items = DB::table('ars_ledgers8')->where('match_flag', 0)->orderBy('date', 'ASC')->get();
